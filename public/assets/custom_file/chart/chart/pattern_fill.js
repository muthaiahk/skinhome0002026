...
function(t) {
	...
	function i(e, i, r, a) {
		e.hasOwnProperty(i) || (e[i] = a.apply(null, r), "function" == typeof CustomEvent && t.win.dispatchEvent(new CustomEvent("HighchartsModuleLoaded", {
			detail: {
				path: i,
				module: e[i]
			}
	...
	i(e, "Extensions/PatternFill.js", [e["Core/Animation/AnimationUtilities.js"], e["Core/Defaults.js"], e["Core/Utilities.js"]], function(t, e, i) {
		...
		function u(t, e) {
			...
			if (e) {
				...
				for (let t = 0; t < r; t += o) a += i.charCodeAt(t);
				a &= a
			}
			for (; n < r; ++n) a = (a << 5) - a + i.charCodeAt(n), a &= a;
			return a.toString(16).replace("-", "1")
		}
		...
		function m() {
			...
			if (i.length)
				for (let r of ([].forEach.call(this.renderTo.querySelectorAll('[color^="url("], [fill^="url("], [stroke^="url("]'), i => {
					...
					}), i)) !t[r] && (s(e.defIds, r), e.patternElements[r] && (e.patternElements[r].destroy(), delete e.patternElements[r]))
		}
		...
		function x(t) {
			let e = t.args[0],
				...
				n = e.pattern,
				o = "#333333";
			if (void 0 !== e.patternIndex && f && (n = f[e.patternIndex]), !n) return !0;
			if (n.image || "string" == typeof n.path || n.path && n.path.d) {
				let t = r.parentNode && r.parentNode.getAttribute("class");
				t = t && t.indexOf("highcharts-legend") > -1, ("defer" === n._width || "defer" === n._height) && M.call({
					graphic: {
						element: r
					}
				}, n), (t || !n.id) && ((n = l({}, n)).id = "highcharts-pattern-" + a + "-" + u(n) + u(n, !0)), this.addPattern(n, !this.forExport && p(n.animation, this.globalAnimation, {
					duration: 100
				})), o = `url(${this.url}#${n.id+(this.forExport?"-export":"")})`
			} else o = n.color || o;
		...
		function L(t, e) {
			let a = p(e, !0),
				n = r(a),
				o = t.color || "#333333",
				s = t.height || ("number" == typeof t._height ? t._height : 0) || 32,
			...
			if (g.id = d, t.path) {
				if (f = i.isObject(t.path) ? t.path : {
					...
					let e;
					e = t.backgroundColor, this.rect(0, 0, h, s).attr({
						fill: e
					}).add(g)
				}
				l = {
					d: f.d
				}, this.styledMode || (l.stroke = f.stroke || o, l["stroke-width"] = p(f.strokeWidth, 2), l.fill = f.fill || "none"), f.transform && (l.transform = f.transform), this.createElement("path").attr(l).add(g), g.color = o
			} else t.image && (a ? this.image(t.image, 0, 0, h, s, function() {
				this.animate({
					opacity: p(t.opacity, 1)
				}, n), c(this.element, "load")
			}).attr({
				opacity: 0
			}).add(g) : this.image(t.image, 0, 0, h, s).add(g));
			return t.image && a || void 0 === t.opacity || [].forEach.call(g.element.childNodes, e => {
				e.setAttribute("opacity", t.opacity)
			}), this.patternElements = this.patternElements || {}, this.patternElements[d] = g, g
		}
		...
		return {
			compose: function(t, e, i) {
				let r = e.prototype.pointClass,
					a = r.prototype;
				a.calculatePatternDimensions || (n(t, "endResize", g), n(t, "redraw", m), h(a, {
					calculatePatternDimensions: M
				}), n(r, "afterInit", y), n(e, "render", w), d(e.prototype, "getColor", b), n(e, "afterRender", _), n(e, "mapZoomComplete", _), h(i.prototype, {
					addPattern: L
				}), n(i, "complexColor", x))
			},
			patterns: f
		}
	}), i(e, "masters/modules/pattern-fill.src.js", [e["Core/Globals.js"], e["Extensions/PatternFill.js"]], function(t, e) {
		return t.patterns = e.patterns, e.compose(t.Chart, t.Series, t.SVGRenderer), t
	})
});