	...
	n(t, "Core/Chart/ChartNavigationComposition.js", [], function() {
		...
		return function(t) {
			...
			function k(e) {
				...
				p.menuClassName = e.menuClassName || "highcharts-menu-" + i.btnCount++, r.symbol && (t = o.symbol(r.symbol, Math.round((r.symbolX || 0) - a / 2), Math.round((r.symbolY || 0) - a / 2), a, a, {
					width: a,
					height: a
			...
			function G(t, n, i, o, r, s, l) {
				...
				S || (a.exportContextMenu = a[y] = S = x("div", {
				...
				}, p.menuStyle)), S.hideMenu = function() {
					m(S, {
						display: "none"
					...
					if ("string" == typeof t && (t = a.options.exporting.menuItemDefinitions[t]), E(t, !0)) {
						...
						t.separator ? n = x("hr", void 0, void 0, C) : ("viewData" === t.textKey && a.isDataTableVisible && (t.textKey = "hideData"), n = x("li", {
							...
							cursor: "pointer"
						}, p.menuItemStyle || {})))), a.exportDivElements.push(n)
					}
				}), a.exportDivElements.push(C, S), a.exportMenuWidth = S.offsetWidth, a.exportMenuHeight = S.offsetHeight);
				let F = {
					display: "block"
				};
				i + (a.exportMenuWidth || 0) > u ? F.right = u - i - r - v + "px" : F.left = i - v + "px", o + s + (a.exportMenuHeight || 0) > d && l.alignOptions?.verticalAlign !== "top" ? F.bottom = d - o - v + "px" : F.top = o + s - v + "px", m(S, F), m(a.renderTo, {
					overflow: ""
				}), m(a.container, {
					overflow: ""
			...
			function L(e) {
				...
				}), t = p.getChartHTML(), w(this, "getSVG", {
					chartCopy: p
				}), t = this.sanitizeSVG(t, i), i = null, p.destroy(), y(o), t
			}
					...
					function t(o) {
						...
						if (r && 1 === o.nodeType && -1 === P.indexOf(o.nodeName)) {
							...
							for (let e in s)(l.isFirefox || l.isMS || l.isSafari || Object.hasOwnProperty.call(s, e)) && function(e, t) {
								...
								for ("transform" === t && "none" === e && (u = !0), d = p.length; d-- && !u;) {
			...
			t.compose = function(e, t) {
				...
				let n = e.prototype;
				n.exportChart || (n.afterPrint = H, n.exportChart = I, n.inlineStyles = q, n.print = A, n.sanitizeSVG = U, n.getChartHTML = W, n.getSVG = L, n.getSVGForExport = $, n.getFilename = R, n.moveContainers = z, n.beforePrint = N, n.contextMenu = G, n.addButton = k, n.destroyExport = D, n.renderExporting = K, n.callbacks.push(j), f(e, "init", V), l.isSafari && g.matchMedia("print").addListener(function(e) {
