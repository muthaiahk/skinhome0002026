...
function(t, e) {
	...
	return i(e, "Core/Globals.js", [], function() {
		var e, i;
		return (i = e || (e = {})).SVG_NS = "http://www.w3.org/2000/svg", i.product = "Highcharts", i.version = "11.4.6", i.win = void 0 !== t ? t : {}, i.doc = i.win.document, i.svg = i.doc && i.doc.createElementNS && !!i.doc.createElementNS(i.SVG_NS, "svg").createSVGRect, i.userAgent = i.win.navigator && i.win.navigator.userAgent || "", i.isChrome = i.win.chrome, i.isFirefox = -1 !== i.userAgent.indexOf("Firefox"), i.isMS = /(edge|msie|trident)/i.test(i.userAgent) && !i.win.opera, i.isSafari = !i.isChrome && -1 !== i.userAgent.indexOf("Safari"), i.isTouchDevice = /(Mobile|Android|Windows Phone)/.test(i.userAgent), i.isWebKit = -1 !== i.userAgent.indexOf("AppleWebKit"), i.deg2rad = 2 * Math.PI / 360, i.hasBidiBug = i.isFirefox && 4 > parseInt(i.userAgent.split("Firefox/")[1], 10), i.marginNames = ["plotTop", "marginRight", "marginBottom", "plotLeft"], i.noop = function() {}, i.supportsPassiveEvents = function() {
			let t = !1;
			if (!i.isMS) {
 ...
 - ${i}: ${e}`, l && (h += encodeURI(i) + "=" + encodeURI(e))
		...
		class r {
			...
			constructor(e) {
				...
				if ("object" == typeof e && void 0 !== e.stops) this.stops = e.stops.map(t => new r(t[1]));
					...
					if (!s)
						for (o = r.parsers.length; o-- && !s;)(i = (a = r.parsers[o]).regex.exec(e)) && (s = a.parse(i))
				}
				s && (this.rgba = s)
			}
			get(t) {
		...
		class B {
			...
			attr(t, e, i, s) {
				let {
					element: o
				} = this, r = B.symbolCustomAttribs, n, l, h = this, d;
			...
			getBBox(t, e) {
				...
				let {
					...
					cache: c,
					cacheKeys: p
				} = l, u = n.namespaceURI === this.SVG_NS, g = T(e, this.rotation, 0), f = l.styledMode ? n && B.prototype.getStyle.call(n, "font-size") : h.fontSize;
			...
			getRotatedBox(t, e) {
				let {
					...
					right: 1,
					center: .5
				} [a || 0] || 0, p = Number(this.element.getAttribute("y") || 0) - (l ? 0 : s), u = e * n, g = (e - 90) * n, f = Math.cos(u), m = Math.sin(u), x = o * f, y = o * m, b = Math.cos(g), v = Math.sin(g), [
					[S, k],
					[M, C]
				] = [h, d].map(t => [t - t * f, t * m]), A = i + c * (o - x) + S + C + p * b, w = A + x, T = w - r * b, P = T - x, O = s + p - c * y - k + M + p * v, L = O + y, D = L - r * v, E = D - y, B = Math.min(A, w, T, P), j = Math.min(O, L, D, E), R = Math.max(A, w, T, P) - B, I = Math.max(O, L, D, E) - j;
				return {
					x: B,
					y: j,
					width: R,
			...
			shadow(t) {
				let {
					renderer: e
				} = this, i = A(this.parentGroup?.rotation === 90 ? {
					offsetX: -1,
					offsetY: -1
		...
		return {
			...
			callout: function(t, e, s, o, r) {
				...
				if (t + h > s - l) {
					if (d > e + l && d < e + o - l) c.splice(3, 1, ["L", t + s, d - 6], ["L", t + s + 6, d], ["L", t + s, d + 6], ["L", t + s, e + o - n]);
					else if (h < s) {
						let i = d < e + l,
							r = i ? e : e + o;
					...
					if (d > e + l && d < e + o - l) c.splice(7, 1, ["L", t, d + 6], ["L", t - 6, d], ["L", t, d - 6], ["L", t, e + n]);
					else if (h > 0) {
						let i = d < e + l,
							s = i ? e : e + o;
		...
		return class {
			...
			addLabel() {
				let e = this,
					...
					v = m.info,
					S = e.label,
					k, M, C, A = this.parameters.category || (n ? u(n[g], p[g], g) : g);
				...
				} : e.shortenLabel = void 0, b && i._addedPlotLB && e.moveLabel(P, f), a(S) || e.movedLabel ? S && S.textStr !== P && !b && (!S.textWidth || f.style.width || S.styles.width || S.css({
					width: null
				}), S.attr({
					text: P
		...
		let {
			...
			splat: R,
			syncTimeout: I
		} = n, z = (t, e) => L(e, void 0, void 0, E(t.options.allowDecimals, e < .5 || void 0 !== t.tickAmount), !!t.tickAmount);
		k(c, {
			xAxis: h,
			yAxis: O(h, d)
		});
		class G {
			...
			init(t, e, i = this.coll) {
				...
				let l = E(r.crosshair, R(t.options.tooltip.crosshairs)[s ? 0 : 1]);
				this.crosshair = !0 === l ? {} : l, -1 === t.axes.indexOf(this) && (s ? t.axes.splice(t.xAxis.length, 0, this) : t.axes.push(this), A(this, t[this.coll])), t.orderItems(this.coll), this.series = this.series || [], t.inverted && !this.isZAxis && s && !y(this.reversed) && (this.reversed = !0), this.labelRotation = T(a.rotation) ? a.rotation : void 0, p(this, r), M(this, "afterInit")
			}
			setOptions(t) {
				let e = this.horiz ? {
					labels: {
				...
				this.options = O(e, c[this.coll], t), M(this, "afterSetOptions", {
					userOptions: t
				})
			}
			defaultLabelFormatter() {
				...
				if (o) u = `${this.value}`;
					...
					for (; d-- && void 0 === u;) h >= (p = Math.pow(l, d + 1)) && 10 * i % p == 0 && null !== n[d] && 0 !== i && (u = e(i / p, -1) + n[d]);
			...
			getPlotLinePath(t) {
				...
				return M(this, "getPlotLinePath", v, function(t) {
					u = f = (c = m(c = E(c, e.translate(a, void 0, void 0, r)), -1e5, 1e5)) + d, g = x = l - c - d, T(c) ? e.horiz ? (g = o, x = l - e.bottom + (e.options.isInternal ? 0 : i.scrollablePixelsY || 0), u = f = b(u, s, s + e.width)) : (u = s, f = h - e.right + (i.scrollablePixelsX || 0), g = x = b(g, o, o + e.height)) : (y = !0, p = !1), t.path = y && !p ? void 0 : i.renderer.crispLine([
						["M", u, g],
						["L", f, x]
					], n || 1)
				}), v.path
			...
			getMinorTickPositions() {
				...
				if (a && a / i < this.len / 3) {
					...
					if (s) this.paddedTicks.forEach(function(t, e, o) {
						...
						for (l = o + (e[0] - o) % i; l <= r && l !== n[0]; l += i) n.push(l)
				}
			...
			setTickInterval(t) {
				let {
					...
					softMax: f,
					softMin: m
				} = l, b = T(g) && i[this.coll]?.[g], v = l.tickPixelInterval, k = l.maxPadding, C = l.minPadding, A = 0, w, P = T(l.tickInterval) && l.tickInterval >= 0 ? l.tickInterval : void 0, O, L, D, B;
			...
			setTickPositions() {
				let t = this.options,
					...
					n = [],
					l;
				if (this.tickmarkOffset = this.categories && "between" === t.tickmarkPlacement && 1 === this.tickInterval ? .5 : 0, this.minorTickInterval = "auto" === s && this.tickInterval ? this.tickInterval / t.minorTicksPerMajor : s, this.single = this.min === this.max && y(this.min) && !this.tickAmount && (this.min % 1 == 0 || !1 !== t.allowDecimals), e) n = e.slice();
				else if (T(this.min) && T(this.max)) {
					if (!this.ordinal?.positions && (this.max - this.min) / this.tickInterval > Math.max(2 * this.len, 200)) n = [this.min, this.max], S(19, !1, this.chart);
						...
						let t = this.tickInterval,
							e = t;
						for (; e <= 2 * t;)
							if (n = this.getLinearTickPositions(this.tickInterval, this.min, this.max), this.tickAmount && n.length > this.tickAmount) this.tickInterval = z(this, e *= 1.1);
							else break
					}
					n.length > this.len && (n = [n[0], n[n.length - 1]])[0] === n[1] && (n.length = 1), i && (this.tickPositions = n, (l = i.apply(this, [this.min, this.max])) && (n = l))
				}
				this.tickPositions = n, this.paddedTicks = n.slice(0), this.trimTicks(n, r, a), !this.isLinked && T(this.min) && T(this.max) && (this.single && n.length < 2 && !this.categories && !this.series.some(t => t.is("heatmap") && "between" === t.options.pointPlacement) && (this.min -= .5, this.max += .5), e || l || this.adjustTickAmount()), M(this, "afterSetTickPositions")
			}
			trimTicks(t, e, i) {
				let s = t[0],
					o = t[t.length - 1],
			...
			renderUnsquish() {
				...
				if (P(o.rotation) || (h.rotation = o.rotation || 0), i.forEach(function(t) {
					...
					for (u = "clip", m = i.length; !a && m--;)(f = s[i[m]].label) && ("ellipsis" === f.styles.textOverflow ? f.css({
						textOverflow: "clip"
			...
			addTitle(t) {
				...
				this.axisTitle || ((e = r.textAlign) || (e = (s ? {
					...
					align: e
				}).addClass("highcharts-axis-title"), a || this.axisTitle.css(O(r.style)), this.axisTitle.add(this.axisGroup), this.axisTitle.isNew = !0), a || r.style.width || this.isRadial || this.axisTitle.css({
					width: this.len + "px"
		...
		return function(t) {
			...
			t.compose = function(t) {
				return t.keepProps.includes("logarithmic") || (t.keepProps.push("logarithmic"), i(t, "init", e), i(t, "afterInit", r)), t
			};
			class a {
				constructor(t) {
					this.axis = t
				...
				getLogTickPositions(t, e, i, r) {
					let a = this.axis,
						...
						l = a.options,
						h = [];
					if (r || (this.minorAutoInterval = void 0), t >= .5) t = Math.round(t), h = a.getLinearTickPositions(t, e, i);
					else if (t >= .08) {
						let s, o, a, n, l, d, c;
						let p = Math.floor(e);
						for (s = t > .3 ? [1, 2, 4] : t > .15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9], o = p; o < i + 1 && !c; o++)
							for (a = 0, n = s.length; a < n && !c; a++)(l = this.log2lin(this.lin2log(o) * s[a])) > e && (!r || d <= i) && void 0 !== d && h.push(d), d > i && (c = !0), d = l
					} else {
		...
		return function(t) {
			...
			function l(t, e, i) {
				...
				let s = this.getPlotLinePath({
					...
					c;
				if (l && s)
					for (n && (c = l.toString() === s.toString(), d = 0), h = 0; h < l.length; h += 2) {
						let t = l[h],
							e = l[h + 1],
							i = s[h],
							o = s[h + 1];
		...
		class c {
			...
			render() {
				...
				let {
					...
					label: b,
					svgElem: v
				} = this, S = [], k, M = o(f) && o(g), C = o(m), A = !v, w = {
					class: "highcharts-plot-" + (M ? "band " : "line ") + (e.className || "")
				}, T = M ? "bands" : "lines";
				if (!t.chart.styledMode && (C ? (w.stroke = r || "#999999", w["stroke-width"] = d(e.width, 1), e.dashStyle && (w.dashstyle = e.dashStyle)) : M && (w.fill = r || "#e6e9ff", x && (w.stroke = e.borderColor, w["stroke-width"] = x))), p.zIndex = c, T += "-" + c, (k = t.plotLinesAndBandsGroups[T]) || (t.plotLinesAndBandsGroups[T] = k = u.g("plot-" + T).attr(p).add()), v || (this.svgElem = v = u.path().attr(w).add(k)), o(m)) S = t.getPlotLinePath({
					value: s?.log2lin(m) ?? m,
				...
				}), this.eventsAdded = !0), (A || !v.d) && S?.length ? v.attr({
					d: S
		...
		class T {
			...
			getAnchor(t, e) {
				...
				if ((t = A(t))[0].series && t[0].series.yAxis && !t[0].series.yAxis.options.reversedStacks && (t = t.slice().reverse()), this.followPointer && e) void 0 === e.chartX && (e = o.normalize(e)), i = [e.chartX - n, e.chartY - a];
			...
			getLabel() {
				...
				if (!this.label) {
					if (this.outside) {
						let t = this.chart.options.chart.style,
							e = o.getRendererType();
						this.container = a = i.doc.createElement("div"), a.className = "highcharts-tooltip-container", f(a, {
							position: "absolute",
							top: "1px",
							pointerEvents: "none",
							zIndex: Math.max(this.options.style.zIndex || 0, (t && t.zIndex || 0) + 3)
						}), this.renderer = n = new e(a, 0, 0, t, void 0, void 0, n.styledMode)
					}
					if (r ? this.label = n.g("tooltip") : (this.label = n.label("", 0, 0, s.shape, void 0, void 0, s.useHTML, void 0, "tooltip").attr({
							padding: s.padding,
							r: s.borderRadius
						}), e || this.label.attr({
						...
						[e.xSetter, e.ySetter].forEach((i, s) => {
							e[s ? "ySetter" : "xSetter"] = o => {
								i.call(e, t.distance), e[s ? "y" : "x"] = o, a && (a.style[s ? "top" : "left"] = `${o}px`)
							}
						})
					}
					this.label.attr({
				...
				return a && !a.parentElement && i.doc.body.appendChild(a), this.label
			}
			getPlayingField() {
				let {
					body: t,
			...
			refresh(t, e) {
				let {
					...
					pointer: o,
					shared: a
				} = this, n = A(t), h = n[0], d = [], c = s.format, p = s.formatter || this.defaultFormatter, u = i.styledMode, g = {};
				if (!s.enabled || !h.series) return;
				r.clearTimeout(this.hideTimer), this.allowShared = !(!b(t) && t.series && t.series.noSharedTooltip), this.followPointer = !this.split && h.series.tooltipOptions.followPointer;
				...
				let v = S(c) ? l(c, g, i) : p.call(g, this),
					k = h.series;
				if (this.distance = M(k.tooltipOptions.distance, 16), !1 === v) this.hide();
				else {
					if (this.split && this.allowShared) this.renderSplit(v, n);
					else {
						let t = m,
							r = x;
						if (e && o.isDirectTouch && (t = e.chartX - i.plotLeft, r = e.chartY - i.plotTop), i.polar || !1 === k.options.clip || n.some(e => o.isDirectTouch || e.series.shouldShowTooltip(t, r))) {
							let t = this.getLabel();
							(!s.style.width || u) && t.css({
								...
								stroke: s.borderColor || h.color || k.color || "#666666"
							}), this.updatePosition({
								plotX: m,
								plotY: x,
								negative: h.negative,
			...
			updatePosition(t) {
				let {
					...
					scaleX: c,
					scaleY: p
				} = r.getChartPosition(), u = (o.positioner || this.getPosition).call(this, l, n, t), g = (t.plotX || 0) + e.plotLeft, m = (t.plotY || 0) + e.plotTop, x;
		...
		class M {
			...
			optionsToObject(t) {
				...
				if (m(t) || null === t) r[s[0]] = t;
					...
					for (!i && t.length > o && ("string" == (a = typeof t[0]) ? r.name = t[0] : "number" === a && (r.x = t[0]), n++); l < o;) i && void 0 === t[n] || (s[l].indexOf(".") > 0 ? M.prototype.setNestedProperty(r, t[n], s[l]) : r[s[l]] = t[n]), n++, l++;
			...
			setState(e, i) {
				...
				}, t.filterUserAttributes(C.attributes || {})))) : x?.point?.haloPath && !x.point.destroyed && x.animate({
		...
		class S {
			...
			drag(t) {
				...
				} = e.options.chart, l = e.plotLeft, h = e.plotTop, d = e.plotWidth, c = e.plotHeight, p = f(r) ? r.enabled : r, u = a && t[`${a}Key`], g = t.chartX, m = t.chartY, x, y = this.selectionMarker;
			...
			setDOMEvents() {
				let t = this.chart.container,
					e = t.ownerDocument;
				t.onmousedown = this.onContainerMouseDown.bind(this), t.onmousemove = this.onContainerMouseMove.bind(this), t.onclick = this.onContainerClick.bind(this), this.eventsToUnbind.push(l(t, "mouseenter", this.onContainerMouseEnter.bind(this)), l(t, "mouseleave", this.onContainerMouseLeave.bind(this))), S.unbindDocumentMouseUp || (S.unbindDocumentMouseUp = l(e, "mouseup", this.onDocumentMouseUp.bind(this)));
				...
				this.eventsToUnbind.push(l(t, "touchstart", this.onContainerTouchStart.bind(this), {
					...
					passive: !1
				})), S.unbindDocumentTouchEnd || (S.unbindDocumentTouchEnd = l(e, "touchend", this.onDocumentTouchEnd.bind(this), {
					passive: !1
		...
		class X {
					...
					if (e) {
						...
						if (j(i) && j(s))
							...
							if (f) {
								...
								for (x = 0; x < M; x++) p[x] = this.autoIncrement(), u[x] = t[x][S];
							else
								for (x = 0; x < M; x++) y = t[x], p[x] = y[v], u[x] = y[S]
						} else e = !1
					}
					if (!e)
						for (x = 0; x < M; x++) y = {
			...
			generatePoints() {
				...
				if (this.options.keys = l, f && (r !== (c = f.length) || n))
					for (g = 0; g < c; g++) g !== a || n || (g += r), f[g] && (f[g].destroyElements(), f[g].plotX = void 0);
			...
			getExtremes(t, e) {
				...
				let k = (t = t || this.stackedYData || h || []).length,
					M = l || this.xData;
				for (i && (b = (d = i.getExtremes()).min, v = d.max), f = 0; f < k; f++)
					if (u = M[f], c = (j(g = t[f]) || B(g)) && ((j(g) ? g > 0 : g.length) || !a), p = e || this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || !i || (M[f + r] || u) >= b && (M[f - r] || u) <= v, c && p) {
						if (m = g.length)
							for (; m--;) j(g[m]) && (o[S++] = g[m]);
						else o[S++] = g
					} let C = {
			...
			getValidPoints(t, e, i) {
				...
				return (t || this.points || []).filter(function(t) {
					...
					return !!((i || !t.isNull && j(r)) && (!e || s.isInsidePlot(o, r, {
						inverted: s.inverted
					}))) && !1 !== t.visible
				})
			}
			...
			animate(t) {
				let {
					...
					group: i,
					markerGroup: s
				} = this, o = e.inverted, r = d(this.options.animation), a = [this.getSharedClipKey(), r.duration, r.easing, r.defer].join(","), n = e.sharedClips[a], l = e.sharedClips[a + "m"];
				if (t && i) {
			...
			pointAttribs(t, e) {
				let i = this.options.marker,
					...
					l, h, d = this.color,
					c, p, u = G(o.lineWidth, i.lineWidth),
					g = 1;
			...
			update(t, e) {
				...
				if (p.forEach(function(t) {
					...
					for (let t of (!1 === (d = i.options).visible ? (h.graphic = 1, h.dataLabel = 1) : (this.hasMarkerChanged(d, o) && (h.graphic = 1), i.hasDataLabels?.() || (h.dataLabel = 1)), this.points)) t && t.series && (t.resolveColor(), Object.keys(h).length && t.destroyElements(h), !1 === d.showInLegend && t.legendItem && s.legend.destroyItem(t));
			...
			setState(t, e) {
				...
				if (t = t || "", i.state !== t && ([i.group, i.markerGroup, i.dataLabelsGroup].forEach(function(e) {
					...
					if (t && (l = a[t].lineWidth || l + (a[t].lineWidthPlus || 0), h = G(a[t].opacity, h)), o && !o.dashstyle && j(l))
		...
		class L {
			...
			update(t, e) {
				let i = this.chart;
				this.setOptions(C(!0, this.options, t)), "events" in this.options && c(this, this.options), this.destroy(), i.isDirtyLegend = i.isDirtyBox = !0, A(e, !0) && i.redraw(), k(this, "afterUpdate", {
					redraw: e
				})
			}
			colorizeItem(t, e) {
				...
				if (s?.[e ? "removeClass" : "addClass"]("highcharts-legend-item-hidden"), !this.chart.styledMode) {
					...
					o?.css(C(e ? this.itemStyle : s)), r?.attr(p({
						stroke: d || t.color
			...
			renderItem(t) {
				...
				!y && (e.group = s.g("legend-item").addClass("highcharts-" + u.type + "-series highcharts-color-" + t.colorIndex + (x ? " " + x : "") + (p ? " highcharts-series-" + t.index : "")).attr({
					zIndex: 1
				}).add(this.scrollGroup), e.label = y = s.text("", c ? a + n : -n, this.baseline || 0, m), i.styledMode || y.css(C(t.visible ? l : h)), y.attr({
					align: c ? "left" : "right",
					zIndex: 2
			...
			align(t = this.chart.spacingBox) {
				let e = this.chart,
					i = this.options,
					s = t.y;
				/(lth|ct|rth)/.test(this.getAlignment()) && e.titleOffset[0] > 0 ? s += e.titleOffset[0] : /(lbh|cb|rbh)/.test(this.getAlignment()) && e.titleOffset[2] > 0 && (s -= e.titleOffset[2]), s !== t.y && (t = C(t, {
					y: s
				})), e.hasRendered || (this.group.placed = !1), this.group.align(C(i, {
			...
			handleOverflow(t) {
				let e = this,
					...
					g = function(t) {
						"number" == typeof t ? S.attr({
							height: t
						}) : S && (e.clipRect = S.destroy(), e.contentGroup.clip()), e.contentGroup.div && (e.contentGroup.div.style.clip = t ? "rect(" + n + "px,9999px," + (n + t) + "px,0)" : "auto")
					},
					f = function(t) {
				...
				}), S || (S = e.clipRect = s.clipRect(0, n - 2, 9999, 0), e.contentGroup.clip(S)), g(m), v || (this.nav = v = s.g().attr({
					zIndex: 1
			...
			scroll(t, e) {
				...
				}), this.currentPage = c, this.positionCheckboxes(), O(() => {
					k(this, "afterScroll", {
						currentPage: c
					})
		...
		class Q {
			...
			redraw(t) {
				...
				let e = this.hasCartesianSeries ? this.axes : this.colorAxis || [],
					...
					g;
				for (a.rootFontSize = a.boxWrapper.getStyle("font-size"), this.setResponsive && this.setResponsive(!1), m(!!this.hasRendered && t, this), n && this.temporaryDisplay(), this.layOutTitles(!1), c = i.length; c--;)
			...
			applyDescription(t, e) {
				...
				}, this.styledMode || o.css(I("title" === t ? {
			...
			getContainer() {
				let t = this.options,
					...
					s = J(),
					o, n = this.renderTo;
				n || (this.renderTo = n = e.renderTo), F(n) && (this.renderTo = n = k.getElementById(n)), n || R(13, !0, this);
				let l = _(P(n, i));
				H(l) && S[l] && S[l].hasRendered && S[l].destroy(), P(n, i, this.index), n.innerHTML = p.emptyHTML, e.skipClone || n.offsetWidth || this.temporaryDisplay(), this.getChartSize();
				...
				this.container = u, this.getChartSize(), c === this.chartWidth || (c = this.chartWidth, this.styledMode || L(u, {
					width: V(e.style?.width, c + "px")
				})), this.containerBox = this.getContainerBox(), this._cursor = u.style.cursor;
				let g = e.renderer || !C ? a.getRendererType(e.renderer) : h;
			...
			reflow(t) {
				let e = this,
					i = e.containerBox,
					s = e.getContainerBox();
				delete e.pointer?.chartPosition, !e.isPrinting && !e.isResizing && i && s.width && ((s.width !== i.width || s.height !== i.height) && (c.clearTimeout(e.reflowTimeout), e.reflowTimeout = q(function() {
			...
			setChartSize(t) {
				...
				}), h.alignElements()), G(this, "afterSetChartSize", {
					skipAxes: t
				})
			}
			resetMargins() {
			...
			addSeries(t, e, i) {
				let s;
				let o = this;
				return t && (e = V(e, !0), G(o, "addSeries", {
					options: t
				}, function() {
					s = o.initSeries(t), o.isDirtyLegend = !0, o.linkSeries(), s.enabledDataSorting && s.setData(t.data, !1), G(o, "afterAddSeries", {
						series: s
					}), e && o.redraw(i)
				})), s
			}
			...
			showLoading(t) {
				let e = this,
					...
					r = e.loadingDiv,
					a = e.loadingSpan;
				r || (e.loadingDiv = r = O("div", {
					className: "highcharts-loading highcharts-loading-hidden"
				}, null, e.container)), a || (e.loadingSpan = a = O("span", {
					className: "highcharts-loading-inner"
				}, null, r), T(e, "redraw", o)), r.className = "highcharts-loading", p.setElementHTML(a, V(t, i.lang.loading, "")), e.styledMode || (L(r, I(s.style, {
					zIndex: 10
				})), L(a, s.labelStyle), e.loadingShown || (L(r, {
					opacity: 0,
					display: ""
				}), g(r, {
			...
			pan(t, e) {
				let i = this,
					...
					a = i.options.chart;
				a?.panning && (a.panning = s), G(this, "pan", {
					originalEvent: t
				}, () => {
					i.transform({
						axes: r,
			...
			transform(t) {
				...
				for (let t of (this.hoverPoints?.forEach(t => t.setState()), e)) {
					let {
						...
						options: g,
						reversed: f
					} = t, m = e ? "width" : "height", x = e ? "x" : "y", y = V(a[m], t.len), b = V(s[m], t.len), v = 10 > Math.abs(y) ? 1 : y / b, S = (s[x] || 0) + b / 2 - t.pos, k = S - ((a[x] ?? t.pos) + y / 2 - t.pos) / v, M = f && !l || !f && l ? -1 : 1;
					...
					let {
						...
						min: O,
						max: L
					} = I(t.getExtremes(), w || {}), E = T ?? g.min, B = P ?? g.max, j = A - C, R = t.categories ? 0 : Math.min(j, B - E), z = E - R * (D(g.min) ? 0 : g.minPadding), G = B + R * (D(g.max) ? 0 : g.maxPadding), N = t.allowZoomOutside || 1 === v || "zoom" !== n && v > 1, W = Math.min(g.min ?? z, z, N ? O : z), X = Math.max(g.max ?? G, G, N ? L : G);
					(!t.isOrdinal || 1 !== v || o) && (C < W && (C = W, v >= 1 && (A = C + j)), A > X && (A = X, v >= 1 && (C = A - j)), (o || t.series.length && (C !== O || A !== L) && C >= W && A <= X) && (r ? r[t.coll].push({
						axis: t,
						min: C,
						max: A
		...
		class g {
			...
			static afterSetSize(t, e) {
				...
				if (!p.forExport && (r ? (t.scrollablePixelsX = i = Math.max(0, r - t.chartWidth), i && (t.scrollablePlotBox = d(t.plotBox), l.width = t.plotWidth += i, n[c ? "height" : "width"] += i, o = !0)) : a && (t.scrollablePixelsY = s = Math.max(0, a - t.chartHeight), h(s) && (t.scrollablePlotBox = d(t.plotBox), l.height = t.plotHeight += s, n[c ? "width" : "height"] += s, o = !1)), h(o) && !e.skipAxes))
					for (let e of t.axes) e.horiz === o && (e.setAxisSize(), e.setAxisTranslation())
			}
			constructor(t) {
				let e;
			...
			applyFixed() {
				let {
					...
					scrollPositionX: x = 0,
					scrollPositionY: y = 0
				} = t.options.chart.scrollablePlotArea || {}, b = a + f, v = n + m;
			...
			moveFixedElements() {
				...
				let {
					...
					scrollablePixelsX: s,
					scrollablePixelsY: o
				} = this.chart, r = this.fixedRenderer, a = g.fixedSelectors;
		...
		class a extends t {
			...
			getGraphPath(t, e, i) {
				...
				return d && t.reverse(), (h = ({
					...
					(d.leftCliff || f && f.rightCliff) && !i && (l = !0), m && !s(e) && c > 0 ? l = !r.connectNulls : m && !e ? l = !0 : (0 === c || l ? p = [
						["M", d.plotX, d.plotY]
						...
						["L", u, g]
					], n.push(d.x), h && (n.push(d.x), 2 === h && n.push(d.x)), a.push.apply(a, p), l = !1)
		...
		return function(t) {
			...
			function i(t, e, i, s, o) {
				...
				} = this, h = this.isCartesian && r.inverted, d = t.plotX, p = t.plotY, g = i.rotation || 0, f = a(d) && a(p) && r.isInsidePlot(d, Math.round(p), {
					inverted: h,
					paneCoordinates: !0,
					series: this
				}), m = 0 === g && "justify" === u(i.overflow, l ? "none" : "justify"), x = this.visible && !1 !== t.visible && a(d) && (t.series.forceDL || l && !m || f || u(i.inside, !!this.options.stacking) && s && r.isInsidePlot(d, h ? s.x + 1 : s.y + s.height - 1, {
					inverted: h,
					paneCoordinates: !0,
					series: this
				})), y = t.pos();
				if (x && y) {
					...
					if (s = n({
						...
						}), m && s.height >= 0) this.justifyDataLabel(e, i, e.alignAttr, a, s, o);
					else if (u(i.crop, !0)) {
						let {
							x: t,
							y: i
		...
		return function(e) {
			...
			function s(t, e) {
				let {
					center: i,
					options: s
				} = this, o = i[2] / 2, r = t.angle || 0, a = Math.cos(r), n = Math.sin(r), l = i[0] + a * o, h = i[1] + n * o, d = Math.min((s.slicedOffset || 0) + (s.borderWidth || 0), e / 5);
				return {
					natural: {
						x: l + a * e,
						y: h + n * e
					...
					h && (t.sortByAngle(e, a - .5), k > 0 && (f = Math.max(0, g - c - k), m = Math.min(g + c + k, i.plotHeight), e.forEach(t => {
						...
						(i.dataLabels || []).forEach(l => {
							let h = l.options || {},
								...
								w = "inherit";
							if (f) {
								if (d && p(g) && f.distance > 0 && (void 0 === g.pos ? w = "hidden" : (S = g.size, A = y.radialDistributionY(i, l))), h.justify) C = y.justify(i, l, c, n);
		...
		function g() {
			if (this.options.borderRadius && !(this.chart.is3d && this.chart.is3d())) {
				let {
					options: t,
					yAxis: e
				} = this, i = "percent" === t.stacking, o = s.plotOptions?.[this.type]?.borderRadius, r = f(t.borderRadius, n(o) ? o : {}), l = e.options.reversed;
		...
		return {
			"navigator-handle": function(e, s, o, r, a = {}) {
				...
				return [
					...
					["L", -1.5, r / 2 + 4.5],
					["M", .5, r / 2 - 3.5],
					["L", .5, r / 2 + 4.5], ...t.rect(-n - 1, .5, 2 * n + 1, r, {
						r: l
					})
				]
			}
		...
		return {
			compose: function(t, e, r) {
				i.compose(e), g(h, "Navigator") && (t.prototype.setFixedRange = c, u(d().prototype.symbols, o), p(r, "afterUpdate", f), l({
					navigator: s
				}))
			}
		}
		...
		return function(t) {
			...
			function d() {
				...
				let {
					scrollMin: o,
					scrollMax: a
				} = i(this), n = this.scrollbar, l = this.axisTitleMargin + (this.titleOffset || 0), h = this.chart.scrollbarsOffsets, d = this.options.margin || 0;
				if (n && h) {
					if (this.horiz) this.opposite || (h[1] += l), n.position(this.left, this.top + this.height + 2 + h[1] - (this.opposite ? d : 0), this.width, this.height), this.opposite || (h[1] += d), t = 1;
					else {
						let e;
		...
		class f {
			...
			position(t, e, i, s) {
				let {
					...
					margin: r = 0,
					vertical: a
				} = this.options, n = this.rendered ? "animate" : "attr", l = s, h = 0;
			...
			render() {
				...
				}).add(this.scrollbarGroup), this.scrollbarRifles = t.path(f.swapXY([
					["M", -3, i / 4],
					["L", -3, 2 * i / 3],
					["M", 0, i / 4],
					["L", 0, 2 * i / 3],
		...
		class P {
			...
			drawOutline(t, e, i, s) {
				...
				i ? (f = d + e + n, e = d + t + n, m = [
					...
					["L", g + c, e],
					["L", g + c, d + h + l]
				], o && m.push(["M", g + c, f - a], ["L", g + c, e + a])) : (g -= l, t += g + l - n, e += g + l - n, m = [
					["M", g, p],
					["L", t, p],
					["L", t, u],
					["M", e, u],
			...
			renderElements() {
				...
				if ([!i, i, !i].forEach((i, o) => {
					...
					[0, 1].forEach(e => {
						...
						} else t.handles[e] = r.symbol(h, -l / 2 - 1, 0, l, o, i), t.handles[e].attr({
							zIndex: 7 - e
			...
			updateNavigatorSeries(t, e) {
				let i = this,
					...
					n, l, d = i.navigatorOptions.series,
					c;
				o && o.length && o.forEach(t => {
					...
					r.name = "Navigator " + (a.length + 1), (l = M(h.navigator.series, {
						color: s.series[e] && !s.series[e].options.isInternal && s.series[e].color || s.options.colors[e] || s.options.colors[0]
					}, r, t)).data = t.data, l.data && (i.hasNavigatorData = !0, a.push(s.initSeries(l)))
			...
			modifyBaseAxisExtremes() {
				...
				let i = this.chart.navigator,
					...
					h = i.stickToMin,
					d = i.stickToMax,
					c = C(this.ordinal?.convertOverscroll(this.options.overscroll), 0),
			...
			function v(t) {
				...
				if (o && "y" !== o.type && e.options.ordinal && e.series.length && (!t.touches || t.touches.length <= 1)) {
					...
					x.ordinal.positions ? Math.abs(f) > 1 && (u && u.forEach(function(t) {
						t.setState()
					}), d > (o = x.ordinal.positions)[o.length - 1] && o.push(d), this.setFixedRange(p - c), (t = e.navigatorAxis.toFixedRange(void 0, void 0, y.apply(x, [b.apply(x, [c, !0]) + f]), y.apply(x, [b.apply(x, [p, !0]) + f]))).min >= Math.min(l.dataMin, c) && t.max <= Math.max(d, p) + i && e.setExtremes(t.min, t.max, !0, !1, {
						trigger: "pan"
					}), this.mouseDownX = s, n(this.container, {
						cursor: "move"
					})) : r = !0
				} else r = !0;
			...
			class M {
				...
				getGroupIntervalFactor(t, e, i) {
					let s = i.processedXData,
						o = s.length,
						r = [],
						a, n, l = this.groupIntervalFactor;
					if (!l) {
		...
		return {
			compose: function(t, e, s) {
				if (o = s, u(a, "RangeSelector")) {
					let s = e.prototype;
					t.prototype.minFromRange = f, n(e, "afterGetContainer", m), n(e, "beforeRender", x), n(e, "destroy", b), n(e, "getMargins", v), n(e, "redraw", y), n(e, "update", S), s.callbacks.push(y), h(r, {
		...
		class C {
			...
			clickButton(t, i) {
				let s = this.chart,
					...
					d = a.dataMin,
					c = a.dataMax,
					u, g = r && Math.round(Math.min(r.max, S(c, r.max))),
					f, y = o._range,
					b, v, k, C = !0;
				if (null !== d && null !== c) {
					if (this.setSelected(t), l && (this.forcedDataGrouping = !0, e.prototype.setDataGrouping.call(r || {
							chart: this.chart
						}, l, !1), this.frozenStates = o.preserveDataGrouping), "month" === n || "year" === n) r ? (v = {
						range: o,
						max: g,
						chart: s,
						dataMin: d,
						dataMax: c
					}, u = r.minFromRange.call(v), x(v.newMax) && (g = v.newMax), C = !1) : y = o;
					else if (y) g = Math.min((u = Math.max(g - y, d)) + y, c), C = !1;
					else if ("ytd" === n) {
						...
						}), i = !1), u = b = (k = this.getYTDExtremes(c, d, s.time.useUTC)).min, g = k.max;
						else {
			...
			updateButtonStates() {
				...
				t.buttonOptions.forEach((e, i) => {
					...
					T ? v[i] = 3 : P && (!S || i === y) && (C = i)
				}), null !== C ? (v[C] = 2, t.setSelected(C)) : (t.setSelected(), s && (s.setState(0), s.attr({
			...
			drawInput(t) {
				let {
					...
					div: i,
					inputGroup: o
				} = this, r = this, a = e.renderer.style || {}, n = e.renderer, h = e.options.rangeSelector, p = l.lang, u = "min" === t;

				function g(t) {
					let {
						maxInput: i,
						minInput: s
					} = r, o = e.xAxis[0], a = e.scroller?.getUnionExtremes() || o, n = a.dataMin, l = a.dataMax, h = e.xAxis[0].getExtremes()[t], d = r.getInputValue(t);
					x(d) && d !== h && (u && i && x(n) ? d > Number(i.getAttribute("data-hc-time")) ? d = void 0 : d < n && (d = n) : s && x(l) && (d < Number(s.getAttribute("data-hc-time")) ? d = void 0 : d > l && (d = l)), void 0 !== d && o.setExtremes(u ? d : o.min, u ? o.max : d, void 0, void 0, {
				...
				let m = p[u ? "rangeSelectorFrom" : "rangeSelectorTo"] || "",
					...
					v = n.label("", 0).addClass("highcharts-range-input").attr({
						padding: 2,
				...
				}(h.inputDateFormat || "%e %b %Y")), e.styledMode || (b.css(y(a, h.labelStyle)), v.css(y({
					color: "#333333"
				}, a, h.inputStyle)), c(S, f({
					position: "absolute",
					border: 0,
			...
			renderButtons() {
				let {
					...
					chart: e,
					options: i
				} = this, o = l.lang, r = e.renderer, a = y(i.buttonTheme), n = a && a.states, c = a.width || 28;
				...
				this.dropdownLabel = r.button("", 0, 0, () => {}, y(a, {
			...
			alignElements() {
				let {
					...
					options: r,
					zoomText: a
				} = this, n = i.options, l = n.exporting && !1 !== n.exporting.enabled && n.navigation && n.navigation.buttonOptions, {
					buttonPosition: h,
					inputPosition: d,
					verticalAlign: c
				} = r, p = (t, e) => l && this.titleCollision(i) && "top" === c && "right" === e.align && e.y - t.getBBox().height - 12 < (l.y || 0) + (l.height || 0) + i.spacing[0] ? -40 : 0, u = i.plotLeft;
				if (s && h && d) {
		...
		class C extends t {
			init(t, e) {
				...
				let d = b({
					...
					scrollbar: {
						enabled: v(r.enabled, !0)
					},
					rangeSelector: {
						enabled: v(o.rangeSelector.enabled, !0)
					},
					title: {
						text: null
					},
		...
		return c(t, "update", function(t) {
				let e = t.options;
				"scrollbar" in e && this.navigator && (b(!0, this.options.scrollbar, e.scrollbar), this.navigator.update({
			...
			function(t) {
				function e(t) {
					...
					let T = c ? this.isXAxis ? u.x : u.y : this.toValue(o ? p.chartX : p.chartY),
						P = u && u.series ? u.series.isPointInside(u) : x(T) && T > C && T < A,
						O = "";
					b ? O = l(b, {
						value: T
					}, e) : s.formatter && x(T) && (O = s.formatter.call(this, T)), g.attr({
						text: O,
						x: m,
						y: y,
				...
				function r(t) {
					...
					if (s.options.isStock && !1 !== t.acrossPanes && "xAxis" === e.coll || "yAxis" === e.coll) {
						for (let o of (t.preventDefault(), S = (t => {
							...
							if (!g(o.options.id) || -1 === o.options.id.indexOf("navigator")) {
		...
		return n.defaultOptions = a(o.defaultOptions, {
			tooltip: o.defaultOptions.tooltip
		}, t), e.registerSeriesType("candlestick", n), n
		...
		return function(t) {
			...
			function i() {
				...
				let t = this,
					...
					v, S, k, M, C;
				if (r && r.visible && y) {
					for (b = (r.pointXOffset || 0) + (r.barW || 0) / 2, M = r.currentDataGrouping, S = h[y - 1].x + (M ? M.totalRange : 0), d(s, (t, e) => t.x - e.x), x = "plot" + x[0].toUpperCase() + x.substr(1); y-- && s[g];)
						if (v = h[y], (f = s[g]).y = v.y, v.x <= f.x && void 0 !== v[x]) {
		...
		class v extends p {
			...
			drawPoints() {
				...
				for (s = u.length; s--;) o = u[s], c = (S ? o.plotY : o.plotX) > this.xAxis.len, t = o.plotX, a = o.stackIndex, i = o.options.shape || k.shape, void 0 !== (e = o.plotY) && (e = o.plotY + M - (void 0 !== a && a * k.stackDistance)), o.anchorX = a ? void 0 : o.plotX, l = a ? void 0 : o.plotY, p = "flag" !== i, r = o.graphic, void 0 !== e && t >= 0 && !c ? (r && o.hasNewShapeType() && (r = r.destroy()), r || (r = o.graphic = v.label("", 0, void 0, i, void 0, void 0, k.useHTML).addClass("highcharts-point").add(this.markerGroup), o.graphic.div && (o.graphic.div.point = o), r.isNew = !0), r.attr({
					...
					y: e,
					anchorY: l
				}, k.allowOverlapX && (h.x = t, h.anchorX = o.anchorX), r.attr({
					text: o.options.title ?? k.title ?? "A"
				})[r.isNew ? "attr" : "animate"](h), k.allowOverlapX || (A[o.plotX] ? A[o.plotX].size = Math.max(A[o.plotX].size, r.width || 0) : A[o.plotX] = {
					align: p ? .5 : 0,
					size: r.width || 0,
					target: t,
					anchorX: t
		...
		return function(e) {
			...
			function f() {
				...
				if (r && a > 0) {
					let e, n;
					for ("value" !== this.options.gapUnit && (r *= this.basePointRange), i && i > r && i >= this.basePointRange && (r = i); a--;)
						if (n && !1 !== n.visible || (n = s[a + 1]), e = s[a], !1 !== n.visible && !1 !== e.visible) {
							if (n.x - e.x > r) {
								let i = (e.x + n.x) / 2;
								s.splice(a + 1, 0, {
									isNull: !0,
		...
		function d(t, e) {
			...
			if (e = a(e, !0), t || (t = {
				...
				for (s = this.series.length; s--;) this.series[s].update({
					dataGrouping: t
				}, !1);
		...
		function f(t) {
			...
			if (A && v && v.length && k) {
				...
				let t = M.getExtremes(),
					p = t.min,
					u = t.max,
					f = C && M.ordinal && M.ordinal.getGroupIntervalFactor(p, u, this) || 1,
					y = A * (u - p) / k * f,
					...
					P = w.groupedYData,
					O = 0;
				for (d && d.smoothed && T.length && (d.firstAnchor = "firstPoint", d.anchor = "middle", d.lastAnchor = "lastPoint", h(32, !1, n, {
						"dataGrouping.smoothed": "use dataGrouping.anchor"
					})), o = 1; o < b.length; o++) b.info.segmentStarts && -1 !== b.info.segmentStarts.indexOf(o) || (O = Math.max(b[o] - b[o - 1], O));
				(m = b.info).gapSize = O, this.closestPointRange = b.info.totalRange, this.groupMap = w.groupMap, this.currentDataGrouping = m,
					function(t, e, i) {
				...
				if (!(e[t] < s[0])) {
					for (; void 0 !== s[C + 1] && e[t] >= s[C + 1] || t === g;) {
						S = s[C], r.dataGroupInfo = {
							...
							length: m[0].length,
							groupStart: S
						}, M = w.apply(r, m), r.pointClass && !l(r.dataGroupInfo.options) && (r.dataGroupInfo.options = p(r.pointClass.prototype.optionsToObject.call({
							series: r
		...
		function u(t) {
			let i = this.chart,
				...
				g = r.xAxis,
				f = p.xDateFormat,
				m, x, y, b, v, S = p[t.isFooter ? "footerFormat" : "headerFormat"];
		...
		let {
			...
			enabled: t ?? !0
		}), n(d, t)), p = function(t, e, s, o, n, l, h) {
