...
function(t) {
	...
	s(e, "Core/Axis/Color/ColorAxisComposition.js", [e["Core/Color/Color.js"], e["Core/Utilities.js"]], function(t, e) {
		...
		return function(t) {
			...
			function h(t) {
				...
				for (e.forEach(function(t) {
					...
					}), l = i.length; l--;) t.allItems.unshift(i[l])
			}
			...
			function g() {
				let t = this,
					...
					o = this.colorKey;
				e.forEach(e => {
					let l = e.getNestedProperty(o),
						r = e.options.color || (e.isNull || null === e.value ? s : i && void 0 !== l ? i.toColor(l, e) : e.color || t.color);
			...
			t.compose = function(t, i, n, C, y) {
				let A = i.prototype,
					b = n.prototype,
					v = y.prototype;
				A.collectionsWithUpdate.includes("colorAxis") || (e = t, A.collectionsWithUpdate.push("colorAxis"), A.collectionsWithInit.colorAxis = [A.addColorAxis], o(i, "afterGetAxes", s), function(t) {
					let s = t.prototype.createAxis;
					t.prototype.createAxis = function(t, i) {
						if ("colorAxis" !== t) return s.apply(this, arguments);
						let o = new e(this, r(i.axis, {
							index: this[t].length,
							isX: !1
						}));
				...
				}(i), b.fillSetter = m, b.strokeSetter = x, o(C, "afterGetAllItems", h), o(C, "afterColorizeItem", d), o(C, "afterUpdate", c), l(v, {
					optionalAxis: "colorAxis",
					translateColors: g
				}), l(v.pointClass.prototype, {
					setVisible: u
				}), o(y, "afterTranslate", p, {
					order: 1
				}), o(y, "bindAxes", f))
			}, t.pointSetVisible = u
		}(s || (s = {})), s
		...
		return (i = s || (s = {})).initDataClasses = function(t) {
			...
			for (let t = 0, s = r.length; t < s; ++t) a = l(a = r[t]), n.push(a), (e.styledMode || !a.color) && ("category" === i.dataClassColor ? (e.styledMode || (h = (c = e.options.colors || []).length, a.color = c[d]), a.colorIndex = d, ++d === h && (d = 0)) : a.color = o(i.minColor).tweenTo(o(i.maxColor), s < 2 ? .5 : t / (s - 1)))
			...
			if (n) {
				for (a = n.length; a--;)
					if (i = (r = n[a]).from, o = r.to, (void 0 === i || t >= i) && (void 0 === o || t <= o)) {
						l = r.color, e && (e.dataClass = a, e.colorIndex = r.colorIndex);
						break
					}
			} else {
				for (s = this.normalizedValue(t), a = h.length; a-- && !(s > h[a][0]););
				i = h[a] || h[a + 1], s = 1 - ((o = h[a + 1] || i)[0] - s) / (o[0] - i[0] || 1), l = i.color.tweenTo(o.color, s)
			}
			return l
		}, s
	}), s(e, "Core/Axis/Color/ColorAxis.js", [e["Core/Axis/Axis.js"], e["Core/Axis/Color/ColorAxisComposition.js"], e["Core/Axis/Color/ColorAxisDefaults.js"], e["Core/Axis/Color/ColorAxisLike.js"], e["Core/Defaults.js"], e["Core/Legend/LegendSymbol.js"], e["Core/Series/SeriesRegistry.js"], e["Core/Utilities.js"]], function(t, e, s, i, o, l, r, a) {
		let {
			defaultOptions: n
		} = o, {
			series: h
		...
		class C extends t {
			...
			init(t, e) {
				...
				this.side = e.side || i ? 2 : 1, this.reversed = e.reversed || !i, this.opposite = !i, super.init(t, e, "colorAxis"), this.userOptions = e, f(t.userOptions.colorAxis) && (t.userOptions.colorAxis[this.index] = e), e.dataClasses && this.initDataClasses(e), this.initStops(), this.horiz = i, this.zoomEnabled = !1
			}
			hasData() {
			...
			setAxisSize() {
				...
				e && (this.left = +e.attr("x"), this.top = +e.attr("y"), this.width = s = +e.attr("width"), this.height = i = +e.attr("height"), this.right = t.chartWidth - this.left - s, this.bottom = t.chartHeight - this.top - i, this.pos = this.horiz ? this.left : this.top), this.len = (this.horiz ? s : i) || C.defaultLegendLength
			}
			getOffset() {
				...
				if (t) {
					...
					s.allItems.forEach(function(t) {
						t instanceof C && t.drawLegendSymbol(s, t)
			...
			drawLegendSymbol(t, e) {
				let s = e.legendItem || {},
					...
					r = m(o.itemDistance, 10),
					a = this.horiz,
					{
						width: n,
						height: h
					} = this.getSize(),
					d = m(o.labelPadding, a ? 16 : 30);
				this.setLegendColor(), s.symbol || (s.symbol = this.chart.renderer.symbol("roundedRect").attr({
					...
					width: n,
					height: h
				}), s.labelWidth = n + i + (a ? r : m(l.x, l.distance) + (this.maxLabelLength || 0)), s.labelHeight = h + i + (a ? d : 0)
			}
			setState(t) {
			...
			getSeriesExtremes() {
				let t = this.series,
					e, s, i, o, l, r, a = t.length,
					n, c;
				for (this.dataMin = 1 / 0, this.dataMax = -1 / 0; a--;) {
					if (s = (r = t[a]).colorKey = m(r.options.colorKey, r.colorKey, r.pointValKey, r.zoneAxis, "y"), o = r.pointArrayMap, l = r[s + "Min"] && r[s + "Max"], r[s + "Data"]) e = r[s + "Data"];
					else if (o) {
						if (e = [], i = o.indexOf(s), n = r.yData, i >= 0 && n)
							for (c = 0; c < n.length; c++) e.push(m(n[c][i], n[c]))
					} else e = r.yData;
					if (l) r.minColorValue = r[s + "Min"], r.maxColorValue = r[s + "Max"];
					else {
						let t = h.prototype.getExtremes.call(r, e);
						r.minColorValue = t.dataMin, r.maxColorValue = t.dataMax
					}
					d(r.minColorValue) && d(r.maxColorValue) && (this.dataMin = Math.min(this.dataMin, r.minColorValue), this.dataMax = Math.max(this.dataMax, r.maxColorValue)), l || h.prototype.applyExtremes.call(r)
				}
			}
			drawCrosshair(t, e) {
				let s;
				let i = this.legendItem || {},
					...
					r = this.pos,
					a = this.len;
				e && ((s = this.toPixels(e.getNestedProperty(e.series.colorKey))) < r ? s = r - 2 : s > r + a && (s = r + a + 2), e.plotX = s, e.plotY = this.len - s, super.drawCrosshair(t, e), e.plotX = o, e.plotY = l, this.cross && !this.cross.addedToColorAxis && i.group && (this.cross.addClass("highcharts-coloraxis-marker").add(i.group), this.cross.addedToColorAxis = !0, this.chart.styledMode || "object" != typeof this.crosshair || this.cross.attr({
			...
			getDataClassLegendSymbols() {
				...
				return i.length || e.dataClasses.forEach((o, h) => {
					let d = o.from,
						...
						g = !0;
					t = "", void 0 === d ? t = "< " : void 0 === f && (t = "> "), void 0 !== d && (t += u(d, r) + a), void 0 !== d && void 0 !== f && (t += " - "), void 0 !== f && (t += u(f, r) + a), i.push(c({
						chart: s,
						name: t,
						options: {},
			...
			getSize() {
				...
				return {
					width: m(d(i) ? x(i, t.chartWidth) : void 0, o?.symbolWidth, e ? C.defaultLegendLength : 12),
					height: m(d(s) ? x(s, t.chartHeight) : void 0, o?.symbolHeight, e ? 12 : C.defaultLegendLength)
				}
			}
		}
		return C.defaultLegendLength = 200, C.keepProps = ["legendItem"], c(C.prototype, i), Array.prototype.push.apply(t.keepProps, C.keepProps), C
