...
if ($('#pageWrapper').hasClass('compact-wrapper')) {
    ...
    jQuery('.sidebar-submenu:not([style*="display: block"]), .menu-content').hide();
    jQuery('.sidebar-title.active').find('div').replaceWith('<div class="according-menu"><i class="fa fa-angle-down"></i></div>');
    ...
    jQuery('.submenu-content:not([style*="display: block"])').hide();
    ...
    // Old JS active URL matching removed in favor of Laravel Request::is() in the Blade template
