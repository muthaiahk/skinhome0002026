	    ...
	    <div class="row second-chart-list third-news-update">
	      ...
	      <div class="col-xl-4 xl-50 news box-col-6">
	        <div class="card">
	          ...
	          <div class="card-body p-0">
	            <div class="news-update media"><img class="img-fluid me-3 b-r-10" src="{{ asset('assets/images/dashboard/update/1.jpg') }}" alt="">
	              <div class="media-body">
	            ...
	            <div class="news-update media"><img class="img-fluid me-3 b-r-10" src="{{ asset('assets/images/dashboard/update/2.jpg') }}" alt="">
	              <div class="media-body">
	            ...
	            <div class="news-update media"><img class="img-fluid me-3 b-r-10" src="{{ asset('assets/images/dashboard/update/3.jpg') }}" alt="">
	              <div class="media-body">
	              ...
	              <div class="card-body pt-0">
	                <div class="appointment-table table-responsive">
	                  <table class="table table-bordernone">
	                    <tbody>
	                      <tr>
	                        <td><img class="img-fluid img-40 rounded-circle mb-3" src="{{ asset('assets/images/appointment/app-ent.jpg') }}" alt="Image description">
	                      ...
	                      <tr>
	                        <td><img class="img-fluid img-40 rounded-circle" src="{{ asset('assets/images/appointment/app-ent.jpg') }}" alt="Image description">
	                          <div class="status-circle bg-primary"></div>
	                        </td>
